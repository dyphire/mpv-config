...
- 目前 mpv 没有官方发布的客户端，官网上有放一些推荐的第三方编译版：[https://mpv.io/installation](https://mpv.io/installation)
  ...
  - 使用 Github Action 编译版：[zhongfly_mpv](https://github.com/zhongfly/mpv-build/releases); [eko5624_mpv](https://github.com/eko5624/mpv-win64/releases/tag/bleeding_edge)
  - 基于个人修改的 libass 编译版：[dyphire_mpv](https://github.com/dyphire/mpv-winbuild/releases)
