...
local copyLogFile = 'flies/mpvClipboard.log' --name+extension of the file that will be used to store the log data
...
local function copy()
	...
	if (filePath ~= nil) then
		...
		local copyLog = utils.join_path(copyLogPath, copyLogFile)
