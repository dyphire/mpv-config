...
| file-browser (group)* | OSD interactive file browser (depends on [user-input.lua](../scripts/user-input.lua); [user-input-module.lua](../script-modules/user-input-module.lua) ; configuration file: [file_browser.conf](../script-opts/file_browser.conf)) |
...
| clipboard.lua* | Provides generic low-level clipboard commands for users and script writers. |
